...
const DeleteAccount: React.FC = () => {
    ...
    return (
        <div className="p-6 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-lg">
            ...
            <Button label="Eliminar Cuenta Permanentemente" severity="danger" onClick={() => setShowConfirmModal(true)}
                icon="pi pi-trash" />

            <Dialog visible={showConfirmModal} modal header="¿Estás absolutamente seguro?"
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <form onSubmit={deleteAccount}>
                        <div className="flex flex-col gap-2">
                            <label htmlFor="delete-password" class="text-slate-700 dark:text-slate-300">Contraseña</label>
