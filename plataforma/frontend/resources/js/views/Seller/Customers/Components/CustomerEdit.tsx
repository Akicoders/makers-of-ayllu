...
const CustomerEdit: React.FC<CustomerEditProps> = ({ show, onClose }) => {
    ...
    const submitForm = () => {
        ...
        post('/vendedor/clientes/update/', {
            data: formData, // Inertia usually sends data automatically, but strict matching Vue logic
            onSuccess: () => {
                onClose();
                clearErrors();
                reset();
    ...
    return (
        <BaseDrawer
            ...
            confirmLabel="Actualizar Cliente"
            loading={processing}
